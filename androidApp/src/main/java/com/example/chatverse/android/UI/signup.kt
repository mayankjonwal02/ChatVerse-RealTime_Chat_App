...
@Composable
fun Signup(currentscreen: MutableState<String>) {
        ...
        contentAlignment = Alignment.Center)
    {
        ...
        )
        {
            ...
            {
                Text(text = "Signup", color = Color.Magenta, fontSize = 40.sp, fontWeight = FontWeight.ExtraBold, fontFamily = FontFamily.Default, fontStyle = FontStyle.Normal)
                ...
                OutlinedTextField(
                    ...
                    },imageVector = if(showpassword1){ Icons.Default.VisibilityOff }else{
                        Icons.Default.Visibility}, contentDescription ="" )
                    },
                    modifier = Modifier.padding(16.dp),
                    ...
                    keyboardOptions = KeyboardOptions.Default.copy(keyboardType = KeyboardType.Password),
                    label = { Text(text = "Confirm Password") },// Placeholder text
                    colors = OutlinedTextFieldDefaults.colors(
                        focusedBorderColor = Color.Blue, // Color when the field is focused
                        unfocusedBorderColor = Color.Gray // Color when the field is not focused
                    )
...
//                    Text(text = "Login" , fontSize = 25.sp, color = Color.White , fontWeight = FontWeight.ExtraBold )
                ...
                Spacer(modifier = Modifier.height(20.dp))
                Text(text = "I already have an account" , color = Color.Magenta , fontWeight = FontWeight.ExtraBold, modifier = Modifier.clickable { currentscreen.value = "login" } )
            }
        }
    }
